...
@section('title', '| Créer un contenu {{$contenu->nom}}')
                ...
                <div class="card-body">
                    <div class="card-title">
                        ...
                        <div class="d-flex justify-content-between bd-highlight mb-3">
                            ...
                            <div class="p-2 bd-highlight">
                                <a href="{{ route('contenus.index') }}" class="btn btn-secondary m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10"><span><i class="fas fa-arrow-left mr-2" aria-hidden="true"></i><span>Retour</span></span> </a>
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::textarea('contenu', null, array('class' => 'form-control', 'id' => 'contenu_editeur')) }}
                        </div>
