...
@section('titre_page', __('messages.aidetexte'). ' | ' . config('app.name'))
...
@section('content')
    ...
    <section class="page-section">
        <div class="container">
            <h2 class="page-section-heading text-center text-uppercase mt-4 mb-0 text-white">{{__('messages.aidetexte')}}</h2>
